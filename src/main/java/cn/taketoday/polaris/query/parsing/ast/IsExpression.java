...
/**
 * {@code expr IS [NOT] TRUE | FALSE | UNKNOWN}
 *
...
public class IsExpression implements Expression {
  ...
  public IsExpression(Expression leftExpression, boolean not, Expression rightExpression) {
  ...
  public String toString() {
    return leftExpression + " IS " + (not ? "NOT " : "") + rightExpression;
  }
