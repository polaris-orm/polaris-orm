 ...
 * @since 1.0 2024/7/21 16:51
 */
public class DefaultTransactionConfig implements TransactionConfig, Serializable {
   ...
   * @see #setName
   */
  public DefaultTransactionConfig() { }
   ...
   * @see #setReadOnly
   */
  public DefaultTransactionConfig(int propagationBehavior) {
