...
public interface TransactionConfig {
   ...
   * defined on {@link TransactionConfig this interface}.
   ...
   * {@link TransactionConfig this interface}. Those constants are designed
   ...
   * 默认实例
   */
  static TransactionConfig forDefaults() {
    return StaticTransactionConfig.INSTANCE;
  }

  static TransactionConfig forIsolationLevel(int isolationLevel) {
    DefaultTransactionConfig definition = new DefaultTransactionConfig();
    definition.setIsolationLevel(isolationLevel);
    return definition;
  }

  static TransactionConfig forIsolationLevel(Isolation isolation) {
    DefaultTransactionConfig definition = new DefaultTransactionConfig();
