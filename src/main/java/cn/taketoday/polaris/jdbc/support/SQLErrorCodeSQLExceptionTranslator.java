...
import cn.taketoday.polaris.jdbc.InvalidResultSetAccessException;
...
public class SQLErrorCodeSQLExceptionTranslator extends AbstractFallbackSQLExceptionTranslator {
  ...
  public SQLErrorCodeSQLExceptionTranslator(ConnectionSource source) {
    this();
    this.sqlErrorCodes = SingletonSupplier.ofNullable(SQLErrorCodesFactory.of().resolveErrorCodes(source));
  }
  ...
  public void setDataSource(DataSource dataSource) {
    this.sqlErrorCodes = SingletonSupplier.ofNullable(SQLErrorCodesFactory.of().resolveErrorCodes(dataSource));
  }
