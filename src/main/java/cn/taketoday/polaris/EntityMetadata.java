...
public class EntityMetadata {
  ...
  @Nullable
  public final cn.taketoday.polaris.EntityProperty idProperty;

  public final BeanProperty[] beanProperties;

  public final String[] columnNames;
  public final cn.taketoday.polaris.EntityProperty[] entityProperties;

  public final String[] columnNamesExcludeId;
  public final cn.taketoday.polaris.EntityProperty[] entityPropertiesExcludeId;
  ...
  private final HashMap<String, cn.taketoday.polaris.EntityProperty> propertyMap;

  protected EntityMetadata(BeanMetadata root, Class<?> entityClass, @Nullable cn.taketoday.polaris.EntityProperty idProperty, String tableName,
          List<BeanProperty> beanProperties, List<String> columnNames, List<cn.taketoday.polaris.EntityProperty> entityProperties) {
    this.root = root;
    ...
    this.entityProperties = entityProperties.toArray(new cn.taketoday.polaris.EntityProperty[0]);
    ...
    this.entityPropertiesExcludeId = entityProperties.toArray(new cn.taketoday.polaris.EntityProperty[0]);
  }

  private HashMap<String, cn.taketoday.polaris.EntityProperty> mapProperties(List<cn.taketoday.polaris.EntityProperty> entityProperties) {
    HashMap<String, cn.taketoday.polaris.EntityProperty> propertyMap = new HashMap<>();
    for (cn.taketoday.polaris.EntityProperty property : entityProperties) {
      propertyMap.put(property.property.getName(), property);
    }
    return propertyMap;
  }

  private boolean determineGeneratedId(@Nullable cn.taketoday.polaris.EntityProperty idProperty) {
    if (idProperty != null) {
   ...
   * obtain id property
   *
   * @throws cn.taketoday.polaris.IllegalEntityException id property not found
   */
  public cn.taketoday.polaris.EntityProperty idProperty() throws cn.taketoday.polaris.IllegalEntityException {
    cn.taketoday.polaris.EntityProperty idProperty = this.idProperty;
    if (idProperty == null) {
